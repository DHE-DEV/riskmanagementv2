...
namespace App\Filament\Resources\AirportCodes\Schemas;
    ...
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ->components([
                    ...
                    ->schema([
                                ...
                                \Filament\Schemas\Components\Grid::make(2)
                                    ->schema([
                                        TextInput::make('iso_country')
                                            ->label('Land (ISO)')
                                            ->maxLength(5)
                                            ->helperText('z.B. DE, US, GB'),
                                        TextInput::make('iso_region')
                                            ->label('Region (ISO)')
                                            ->maxLength(10)
                                            ->helperText('z.B. DE-BY, US-CA'),
                                    ]),
                        ...
                        \Filament\Schemas\Components\Grid::make(1)
                            ...
                            ->schema([
                                ...
                                Select::make('scheduled_service')
                                    ->label('Linienflugverkehr')
                                    ->options([
                                        'yes' => 'Ja',
                                        'no' => 'Nein',
                                    ])
                                    ...
                                    ->afterStateUpdated(function ($set, ?string $state) {
                                        ...
                                        if (count($parts) >= 2) {
                                            ...
                                            if (is_numeric($lat) && is_numeric($lng)) {
                                                $set('latitude_deg', $lat);
                                                $set('longitude_deg', $lng);
                                            }
                                        }
                                    }),
                ...
                // Zusätzliche Links Section
                Section::make('Links & Suchbegriffe')
                    ->schema([
                        \Filament\Schemas\Components\Grid::make(2)
                            ->schema([
                ...
                // Zweites Grid - Zusätzliche Informationen (Lounges, Hotels, Mobilität)
                \Filament\Schemas\Components\Grid::make(2)
                    ->columnSpanFull()
                    ->columns([
                        'default' => 1,
                    ...
                    ->schema([
                        // Linke Spalte - Lounges + Mobilitätsangebote
                        \Filament\Schemas\Components\Grid::make(1)
                            ->columnSpan(1)
                            ->schema([
                                // Lounges Section
