<x-filament-panels::page>
    ...
    <div style="display: flex; gap: 0; border-bottom: 1px solid #e5e7eb; margin-bottom: 1rem;">
        @foreach(['all' => 'Alle', 'gtm-notifications' => 'GTM', 'travel-alert-notifications' => 'Travel Alert'] as $key => $label)
        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 0.8125rem;">
            <thead>
                <tr style="background: #f9fafb; border-bottom: 1px solid #e5e7eb;">
                    ...
                    <th style="padding: 0.75rem 1rem; text-align: center; font-weight: 600; color: #374151;">Events</th>
                    <th style="padding: 0.75rem 1rem; text-align: center; font-weight: 600; color: #374151;">Gesendet</th>
                    ...
                    <tr style="border-bottom: 1px solid #f3f4f6; {{ $log->status === 'failed' ? 'background: #fef2f2;' : '' }}">
                        <td style="padding: 0.75rem 1rem;">
                            <span style="display: inline-flex; align-items: center; gap: 6px; padding: 3px 10px; border-radius: 9999px; font-size: 0.6875rem; font-weight: 600;
                                {{ $log->queue_name === 'gtm-notifications' ? 'background: #dbeafe; color: #1e40af;' : 'background: #fef3c7; color: #92400e;' }}">
                                {{ $log->queue_name }}
                            </span>
                        </td>
