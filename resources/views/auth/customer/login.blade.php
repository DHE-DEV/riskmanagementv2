        ...
        <div class="mt-6">
            <div class="relative">
                ...
                <div class="relative flex justify-center text-sm">
                    <span class="px-2 bg-gray-100 dark:bg-gray-900 text-gray-500">Oder anmelden mit</span>
                </div>
            </div>

            <div class="mt-6">
                <a href="{{ route('auth.keycloak.redirect') }}"
                   class="w-full inline-flex justify-center items-center py-3 px-4 border border-transparent rounded-md shadow-sm bg-[#4e73df] text-sm font-medium text-white hover:bg-[#3a5bc7] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#4e73df]">
