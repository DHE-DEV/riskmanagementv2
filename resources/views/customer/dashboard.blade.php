...
@section('title', 'Customer Dashboard - Passolution Travel Information Platform')
            ...
            <div class="bg-white shadow-sm rounded-lg p-6 border border-gray-200">
                    ...
                    <div class="bg-white p-6 rounded-lg border border-gray-200">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                @endphp
                                @if($mitgliedSeit)
                                    <span class="px-2 py-1 bg-gray-50 text-gray-600 text-xs font-medium rounded border border-gray-200">
                ...
                @php
                    ...
                    $ssoData = [
                        ...
                        'pds_id' => $ssoCustomer->pds_id,
                        'pds_name' => $ssoCustomer->pds_name,
                        'pds_username' => $ssoCustomer->pds_username,
                        'pds_email' => $ssoCustomer->pds_email,
                        'pds_account_id' => $ssoCustomer->pds_account_id,
                        'pds_account_type' => $ssoCustomer->pds_account_type,
                        'pds_account_name' => $ssoCustomer->pds_account_name,
                        'pds_account_first_name' => $ssoCustomer->pds_account_first_name,
                        'pds_account_last_name' => $ssoCustomer->pds_account_last_name,
                        'pds_account_email' => $ssoCustomer->pds_account_email,
                        'pds_account_phone' => $ssoCustomer->pds_account_phone,
                        'pds_account_address_line_1' => $ssoCustomer->pds_account_address_line_1,
                        'pds_account_zip_code' => $ssoCustomer->pds_account_zip_code,
                        'pds_account_city' => $ssoCustomer->pds_account_city,
                        'pds_account_state' => $ssoCustomer->pds_account_state,
                        'pds_account_country' => $ssoCustomer->pds_account_country,
                        'pds_account_subscription_type' => $ssoCustomer->pds_account_subscription_type,
