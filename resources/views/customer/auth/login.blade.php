...
@section('title', 'Login - Passolution Travel Information Platform')
        ...
        <div class="flex w-full max-w-xl flex-col gap-6">
            ...
            <div class="flex flex-col gap-6">
                <div class="rounded-xl border bg-white text-stone-800 shadow-lg">
                    <div class="px-8 py-8 sm:px-10">
                        ...
                        <div class="flex w-full flex-col text-center mb-6">
                            ...
                            <p class="text-sm text-stone-600">Melden Sie sich bei Ihrem Kundenkonto an</p>
                        </div>

                        <!-- Session Status -->
                        @if (session('status'))
                            <div class="mb-6 rounded-lg bg-green-50 border border-green-200 p-4 text-sm text-green-800 text-center">
                                {{ session('status') }}
                            </div>
                        @endif
                        ...
                        <div x-data="{ tab: '{{ old('_tab', 'email') }}' }">
                            <div class="flex gap-2 border-b-2 border-stone-200 mb-6">
                                <button type="button"
                                        @click="tab = 'email'"
                                        :class="tab === 'email'
                            ...
                            <div x-show="tab === 'email'" x-cloak>
                                ...
                                @if(request('code_sent'))
                                    ...
                                    <div>
                                        <p class="text-sm text-stone-600 mb-2 text-center">
                                            Wir haben einen 6-stelligen Code an diese E-Mail-Adresse gesendet:
                                        </p>
                                        <p class="text-sm font-semibold text-stone-900 mb-5 text-center">{{ request('email', '') }}</p>
                                        ...
                                        <div id="code-inputs" class="flex justify-center gap-2 sm:gap-3 mb-2">
                                            ...
                                            <input
                                                ...
                                                data-code-input
                                                data-index="{{ $i }}"
                                                class="w-11 h-14 sm:w-12 sm:h-16 text-center text-xl sm:text-2xl font-bold rounded-lg border border-stone-300 bg-white text-stone-900 focus:outline-none focus:ring-2 focus:border-blue-500 focus:ring-blue-500/20 transition-colors"
                                            >
                                            @endfor
                                        </div>

                                        <!-- Error message -->
                                        <p id="code-error" class="text-sm text-red-600 text-center mb-4" style="display: none;"></p>
                                        ...
                                        <div id="code-loading" class="flex items-center justify-center gap-2 py-3" style="display: none;">
                                            ...
                                            <span class="text-sm text-stone-600">Wird geprüft...</span>
                                        </div>
                                        ...
                                        <div id="code-actions" class="mt-5 space-y-3">
                                            <button
                                                id="code-resend"
                                                disabled
                                                class="w-full rounded-lg border border-stone-300 bg-white hover:bg-stone-50 px-4 py-2.5 text-sm font-medium text-stone-700 shadow-sm transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
                                            >
                                            ...
                                            <a href="{{ route('customer.login') }}"
                                                class="block w-full text-center text-sm text-stone-500 hover:text-stone-700 transition-colors"
                                ...
                                @else
                                    ...
                                    <form method="POST" action="{{ route('customer.magic-login.send') }}" class="space-y-5">
                                        ...
                                        <div>
                                            <label for="magic_email" class="block text-sm font-medium text-stone-700 mb-2">
                                                E-Mail-Adresse
                                            </label>
                                            <input
                                                id="magic_email"
                                                ...
                                                class="block w-full rounded-lg border border-stone-300 bg-white px-4 py-2.5 text-stone-900 placeholder-stone-400 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-colors"
                                            >
                                            @error('email')
                                        ...
                                        <button
                                            type="submit"
                                            class="w-full rounded-lg bg-blue-600 hover:bg-blue-700 active:bg-blue-800 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                                        >
                                            Login-Code senden
                                        </button>
                                    </form>
                ...
                <div class="text-center text-sm text-stone-600">
                    ...
                    <a href="{{ route('customer.register') }}" class="font-medium text-blue-600 hover:text-blue-500 transition-colors">
                        Konto erstellen
                    </a>
                </div>
            </div>
